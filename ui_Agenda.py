...
"font: 13pt;")
        ...
        self.listWidget.setGeometry(QtCore.QRect(660, 180, 391, 351))
...
"font:12pt;")
        ...
        self.pushButton = QtWidgets.QPushButton(Calendar)
        self.pushButton.setGeometry(QtCore.QRect(710, 600, 211, 71))
    ...
    def retranslateUi(self, Calendar):
        ...
        self.pushButton.setText(_translate("Calendar", "Save Changes"))
